...
<div class="container-fluid" id="container-wrapper">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-1.5">
		<h1 class="h3 text-gray-800 title-underline page-title">Profil Saya</h1>
	</div>
		...
		<div class="col-lg-12">
			...
			<div class="card mb-4 fade-stagger">
				...
				<div class="card-body stagger-item">
					...
					<form method="POST" action="<?= base_url('panel/profileupdate') ?>">

						<div class="form-group">
							<label>Nama</label>
							<input type="text" name="nama" value="<?= $profile->nama ?>" class="form-control" required>
						</div>
