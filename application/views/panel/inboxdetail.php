...
<div class="container-fluid" id="container-wrapper">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-2">
		<h1 class="h3 mb-0 text-gray-800 title-underline page-title">Detail Pesan</h1>
	</div>
	...
	<div class="breadcrumb-container mb-4">
		<nav aria-label="breadcrumb">
			...
			">
				...
				<li class="breadcrumb-item stagger-item">
					<a href="<?= base_url('panel/inbox') ?>" style="text-decoration: none; color: #007bff;">
						Inbox
					</a>
				</li>
	...
	<div class="card shadow mb-4 fade-stagger">
		...
		<div class="card-header py-3 fade-stagger">
			<h6 class="m-0 font-weight-bold text-primary stagger-item">Informasi Pesan Masuk</h6>
		</div>
		...
		<div class="card-body stagger-item">
			...
			<div class="row">
				...
				<div class="col-md-6 mb-3">
					...
					<p class="form-control-plaintext"><?= htmlspecialchars($inbox->nama) ?></p>
				</div>

				<div class="col-md-6 mb-3">
					<label><strong>Email:</strong></label>
					<p class="form-control-plaintext"><?= htmlspecialchars($inbox->email) ?></p>
				</div>

				<div class="col-md-6 mb-3">
					<label><strong>Tanggal:</strong></label>
					<p class="form-control-plaintext">
						<?= date('d-m-Y H:i', strtotime($inbox->tanggal)) ?>
					</p>
				</div>

				<div class="col-md-12 mb-3">
					<label><strong>Isi Pesan:</strong></label>
					<div class="p-3" style="background:#f8f9fc; border-radius:6px; border:1px solid #e3e6f0;">
						<?= nl2br(htmlspecialchars($inbox->pesan)) ?>
					</div>
				</div>
			...
			<!-- ACTION BUTTONS -->
			<div class="mt-4">
				<a href="<?= base_url('panel/inbox') ?>" class="btn btn-secondary stagger-item">
					<i class="fas fa-arrow-left"></i> Kembali
				</a>

				<a href="<?= base_url('panel/inboxhapus/' . $inbox->id) ?>"
					class="btn btn-danger stagger-item"
